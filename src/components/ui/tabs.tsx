...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-0.5 text-muted-foreground group-data-horizontal/tabs:h-12 md:group-data-horizontal/tabs:h-10 group-data-vertical/tabs:h-fit md:group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-background data-active:text-primary-900 dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-primary-400",
